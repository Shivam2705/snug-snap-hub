...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({
  className,
  ...props
}, ref) => <div ref={ref} className={cn("rounded-lg border bg-card text-card-foreground border-none shadow-md opacity-95 border-primary-foreground", className)} {...props} />);
